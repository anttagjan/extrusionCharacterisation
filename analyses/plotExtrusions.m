function plotExtrusions(filenames,extrusions_transformed,landmarks_transformed)
...
%% ===== Callbacks =====
    ...
    function updateScatter()
        ...
        idxTime = (extrusions_transformed(:,3) >= tMinVal) & (extrusions_transformed(:,3) <= tMaxVal);
        ...
        scatter_handle.XData = extrusions_transformed(idxFilt,1);
        scatter_handle.YData = extrusions_transformed(idxFilt,2);
